  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-50 max-w-[400px] mx-auto rounded-[16px] p-4 flex items-start gap-3 animate-fade-in"
      ...
      <div className="flex-1">
        <p className="text-foreground text-sm font-medium">{t("Für das beste Erlebnis:")}</p>
        <p className="text-muted-foreground text-xs mt-1">{t("Teilen → Zum Home-Bildschirm")}</p>
      </div>
